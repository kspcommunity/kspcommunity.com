...
// esbuild_serve:http-import:https://raw.githubusercontent.com/micku7zu/vanilla-tilt.js/master/dist/vanilla-tilt.min.js
var require_vanilla_tilt_min = __commonJS({
  "esbuild_serve:http-import:https://raw.githubusercontent.com/micku7zu/vanilla-tilt.js/master/dist/vanilla-tilt.min.js"() {
    init_polyfill();
    init_bug_reporter();
    init_mod();
    ...
    var VanillaTilt = function() {
      ...
      class t {
        ...
        onDeviceOrientation(t2) {
          if (null === t2.gamma || null === t2.beta)
            return;
          this.updateElementPosition(), this.gyroscopeSamples > 0 && (this.lastgammazero = this.gammazero, this.lastbetazero = this.betazero, null === this.gammazero ? (this.gammazero = t2.gamma, this.betazero = t2.beta) : (this.gammazero = (t2.gamma + this.lastgammazero) / 2, this.betazero = (t2.beta + this.lastbetazero) / 2), this.gyroscopeSamples -= 1);
          const e = this.settings.gyroscopeMaxAngleX - this.settings.gyroscopeMinAngleX, i4 = this.settings.gyroscopeMaxAngleY - this.settings.gyroscopeMinAngleY, s = e / this.width, n2 = i4 / this.height, l2 = (t2.gamma - (this.settings.gyroscopeMinAngleX + this.gammazero)) / s, a2 = (t2.beta - (this.settings.gyroscopeMinAngleY + this.betazero)) / n2;
          null !== this.updateCall && cancelAnimationFrame(this.updateCall), this.event = { clientX: l2 + this.left, clientY: a2 + this.top }, this.updateCall = requestAnimationFrame(this.updateBind);
        }
        onMouseEnter() {
          this.updateElementPosition(), this.element.style.willChange = "transform", this.setTransition();
        }
        onMouseMove(t2) {
          null !== this.updateCall && cancelAnimationFrame(this.updateCall), this.event = t2, this.updateCall = requestAnimationFrame(this.updateBind);
        }
        onMouseLeave() {
        ...
        getValues() {
          let t2, e;
          return this.fullPageListening ? (t2 = this.event.clientX / this.clientWidth, e = this.event.clientY / this.clientHeight) : (t2 = (this.event.clientX - this.left) / this.width, e = (this.event.clientY - this.top) / this.height), t2 = Math.min(Math.max(t2, 0), 1), e = Math.min(Math.max(e, 0), 1), { tiltX: (this.reverse * (this.settings.max - t2 * this.settings.max * 2)).toFixed(2), tiltY: (this.reverse * (e * this.settings.max * 2 - this.settings.max)).toFixed(2), percentageX: 100 * t2, percentageY: 100 * e, angle: Math.atan2(this.event.clientX - (this.left + this.width / 2), -(this.event.clientY - (this.top + this.height / 2))) * (180 / Math.PI) };
        }
        ...
        prepareGlare() {
          if (!this.glarePrerender) {
            ...
            e.classList.add("js-tilt-glare-inner"), t2.appendChild(e), this.element.appendChild(t2);
          }
        ...
        updateGlareSize() {
          if (this.glare) {
            const t2 = 2 * (this.element.offsetWidth > this.element.offsetHeight ? this.element.offsetWidth : this.element.offsetHeight);
            Object.assign(this.glareElement.style, { width: `${t2}px`, height: `${t2}px` });
          }
        }
        updateClientSize() {
        ...
        static init(e, i4) {
          e instanceof Node && (e = [e]), e instanceof NodeList && (e = [].slice.call(e)), e instanceof Array && e.forEach((e2) => {
            "vanillaTilt" in e2 || (e2.vanillaTilt = new t(e2, i4));
          });
        }
      }
...
init_main();
init_popover_polyfill();
var Popover = (content) => new class extends Component {
  constructor() {
    super();
...
init_main();
init_popover_polyfill();
var BasicLabel = (content) => EntryComponent.basicContent(content);
var EntryComponent = class extends Component {
  ...
  constructor(content) {
    super();
    this.wrapper = Layer(
      content instanceof Component ? content : BasicLabel(content),
      2,
      "shadow"
...
var splash_default = "./splash-HF3HUSE7.png";
...
var streamingPool = lazyInit(async () => {
...
function Footer() {
  return Box(
    Box(
      Image(splash_default, "Splash Image").addClass("splash-image"),
      Box(
        Box(
          Label("Looks Dope?\nJoin now!").addClass("title"),
          Label("Delivering Excellence. Empowering Businesses and\nIndividuals with Premium Services").addClass("subtitle")
        ).addClass("text-section"),
        LinkButton("Get started", "/signin").addClass("round-button", "large-button")
      ).addClass("area-fg"),
      Box(
        Box(
          ...[
            ...
            ([text, items]) => Grid(
              Label(text).addClass("title"),
              ...items.map(
                ([title, link]) => LinkButton(title, link).addClass("link").setStyle("inline" /* Inline */)
              )
            ).addClass("column")
          )
...
// pages/holding/resources/bbnCard.svg
var bbnCard_default = "./bbnCard-WSK5WM7Y.svg";

// pages/holding/resources/bbnGameStudios.svg
var bbnGameStudios_default = "./bbnGameStudios-CRAG7Q2K.svg";

// pages/holding/resources/bbnPublishing.svg
var bbnPublishing_default = "./bbnPublishing-7XVAO7SL.svg";
...
Body(Box(
  ...
  Vertical(
    Box(
      ...
      Label("Your\xA0Journey,\xA0 our\xA0Mission.").setFontWeight("bold")
    ).addClass("big-title"),
    Box(
      Label("BBN One", "h2"),
    ...
    Box(
      Image(bbnCard_default, "A logo from BBN Card"),
      Image(bbnGameStudios_default, "A logo from BBN Games Studios"),
      Image(bbnPublishing_default, "A logo from BBN Publishing")
    ).addClass("other-services-images"),
    Box(Box()).addClass("glowbs", "purple")
  ).addClass("content").setAlignItems("center"),
  Footer()
));
Promise.resolve().then(() => __toESM(require_vanilla_tilt_min()));
await streamingPool();
/*!
 * Platform.js v1.3.6
