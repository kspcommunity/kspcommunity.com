...
Body(Box(
  ...
  Box(
    ...
    Label(
      `KSP Community Inc., a Mississippi c - corporation(\u201CKSP Community\u201D, "BBN Music", "BBN", \u201Cwe\u201D, or \u201Cus\u201D) provides access to the BBN website, currently located at bbn.one and all associated websites and subpages, including any and all related mobile applications we may make available(collectively, \u201CApplication\u201D), together with all enabled features, functionality and services.These terms and conditions(\u201CTerms\u201D) govern your access and use(as a registered user or otherwise) of the Services.`
    ),
    Label(
      `By accessing or using the Services in any way, you represent and warrant that you have read, understood, and accept and agree to be bound by these Terms. If you do not agree, you may not access or use the Services. Your use of BBN's distribution services, if applicable, is separately governed by the BBN Music Distribution Agreement, and any of its attachments or addendum, located here (https://bbn.one/p/distribution.html).`
    ),
    Label(`Terms of Access and Use`, "h3"),
    Label(
      `Subject to these Terms, we grant you a limited, non-exclusive, nontransferable personal license to access and use the Services. By accessing and using the Services, you represent and warrant that you are over eighteen (18) years of age or the applicable age of majority in your jurisdiction, and that you are either an individual acting on your own behalf, or the authorized agent of another individual or business. Your use of the Services as an authorized agent shall not relieve you of personal responsibility for your use of the Services. The rights granted to you by these Terms may be revoked by BBN at any time, in its sole discretion.`
    ),
    Label(
    ...
    Label(`Registration and Accounts`, "h3"),
    Label(
    ...
    Label(`Privacy`, "h3"),
    Label(
      `For information regarding our collection and use of information you provide to us, please refer to the Services' privacy policy (\u201CPrivacy Policy\u201D), located here (https://bbn.one/p/privacy.html) which shall supplement and be incorporated into these Terms by reference. By entering into these Terms, you agree to our collection, use and disclosure of your personal information in accordance with our Privacy Policy.`
    ),
    Label(`User Content and Activity`, "h3"),
    Label(
