...
// pages/holding/distributionAgreement.ts
init_polyfill();
init_bug_reporter();
init_mod();
init_urlpattern_polyfill();
...
Body(Box(
  ...
  Box(
    ...
    Label(`By clicking to agree to this Agreement, you are accepting the terms and conditions below, so please read and understand them completely before doing so. This Agreement will automatically become effective on the date you click to agree to this Agreement (the \u201CEffective Date \u201D).`).addClass("block"),
