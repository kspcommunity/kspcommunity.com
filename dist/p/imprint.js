...
Body(Box(
  ...
  Box(
    ...
    Horizontal(
      Label("See also:"),
      LinkButton("Privacy Policy", "/p/privacy-policy").setStyle("inline" /* Inline */),
      LinkButton("Terms of Use", "/p/terms-of-use").setStyle("inline" /* Inline */),
      Spacer()
