...
// esbuild_serve:http-import:https://raw.githubusercontent.com/lucsoft/WebGen/d389a5b/src/components/Content.ts
init_polyfill();
init_bug_reporter();
init_mod();
init_urlpattern_polyfill();
...
var SectionComponent = class extends Component {
  constructor(sectionId, elements) {
    super();
...
var FullWidthSection = (...elements) => new SectionComponent("full-width", elements).addClass("full-width-section");
var ContentComponent = class extends Component {
...
var Content = (...elements) => new ContentComponent(...elements);
...
// pages/music-landing/assets/apple.svg
var apple_default = "./apple-I2UCBHM2.svg";

// pages/music-landing/assets/deezer.svg
var deezer_default = "./deezer-DZN3B26U.svg";

// pages/music-landing/assets/facebook.svg
var facebook_default = "./facebook-75B6DLTX.svg";

// pages/music-landing/assets/instagram.svg
var instagram_default = "./instagram-S4CNTFW3.svg";

// pages/music-landing/assets/pandora.svg
var pandora_default = "./pandora-RIYXXQ4I.svg";

// pages/music-landing/assets/spotify.svg
var spotify_default = "./spotify-FSVGT3MX.svg";

// pages/music-landing/assets/tidal.svg
var tidal_default = "./tidal-HB3FDSI5.svg";

// pages/music-landing/assets/tiktok.svg
var tiktok_default = "./tiktok-Y4QGEQW3.svg";

// pages/music-landing/assets/youtube.svg
var youtube_default = "./youtube-VDLNYB2H.svg";

// pages/music-landing/assets/criticz.jpg
var criticz_default = "./criticz-6MJJ34A7.jpg";

// pages/music-landing/assets/redz.jpg
var redz_default = "./redz-EYJHHBX5.jpg";

// pages/music-landing/main.ts
WebGen();
await RegisterAuthRefresh();
var images = () => Array.from({ length: 4 }, () => [
  Image(apple_default, "Apple Music"),
  Image(deezer_default, "Deezer"),
  Image(facebook_default, "Facebook"),
  Image(instagram_default, "Instagram"),
  Image(pandora_default, "Pandora"),
  Image(spotify_default, "Spotify"),
  Image(tidal_default, "Tidal"),
  Image(tiktok_default, "TikTok"),
  Image(youtube_default, "Youtube")
]).flat();
var isMobileKeyFeatures = mediaQueryRef("(max-width: 820px)");
Body(
  Content(
    FullWidthSection(
    ...
    Content(
      Grid(
        Box(
          Label("Drop in with\nyour Audience").setTextSize("7xl").setTextAlign("start").setBalanced().setFontWeight("black")
        ).addClass("max-width-30rem").setWidth("100%").setMargin("10rem 0 0 0"),
        Box(
          Label("BBN Music, your gateway to unlimited music distribution at a low cost. Maximize your reach without limits. Join us and let the world hear your music.").setTextSize("xl").setBalanced().addClass("line-height-1-2").setFontWeight("medium")
        ).addClass("max-width-30rem"),
        LinkButton("Drop your Music", "/c/music").setPadding("12px 30px").setFontWeight("bold").setTextSize("lg").addClass("orange-bg", "orange-box-shadow").setBorderRadius("large")
      ).setGap("25px").setJustifyItems("start")
    ).setMaxWidth("900px"),
    Content(
      Grid(
        Label("Our pricing plan to disrupt the Market:").setFontWeight("bold").setMargin("135px 0 40px 0").setTextAlign("center").addClass("opacity-60")
      ),
      Grid(
        Grid(
          Label("Free Plan").setFontWeight("black").setWidth("max-content").setPadding("0 5px").setBorderRadius("tiny").addClass("badge-free-tier-bg"),
          Grid(
            Label("Your Revenue").setTextSize("lg").setFontWeight("bold"),
            Label("97%").addClass("line-height-0-8", "xl7-5").setFontWeight("black")
          ),
          Label("No Extra Cost").setTextSize("3xl").setFontWeight("bold").addClass("opacity-60"),
          Grid(
          ...
          ).addClass("feature-list").setGap("20px").setRawColumns("max-content auto"),
          LinkButton("Drop Now!", "/c/music").setPadding("12px 30px").setFontWeight("bold").setTextSize("lg").setBorderRadius("large").addClass("orange-bg", "orange-box-shadow").setJustifyContent("center")
        ).setGap("30px").setPadding("45px 40px").addClass("extra-large-br").addClass("free-tier-bg").setAlignContent("start"),
        Grid(
          Label("Paid Plan").setFontWeight("black").setWidth("max-content").setPadding("0 5px").setBorderRadius("tiny").addClass("badge-paid-tier-bg"),
          Grid(
            Label("Your Revenue").setTextSize("lg").setFontWeight("bold"),
            Label("100%").addClass("line-height-0-8", "xl7-5").setFontWeight("black")
          ),
          Label("1\u20AC per Year").setTextSize("3xl").setFontWeight("bold").addClass("opacity-60"),
          Grid(
            MIcon("check_circle", "outlined"),
            Label("Unlimited Drops"),
            MIcon("check_circle", "outlined"),
          ...
          ).addClass("feature-list").setGap("20px").setAlignItems("center").setRawColumns("max-content auto"),
          Button("Coming Soon").setColor("disabled" /* Disabled */).setPadding("25px 30px").setBorderRadius("large").setJustifyContent("center")
        ).setGap("30px").setPadding("45px 40px").addClass("extra-large-br").addClass("paid-tier-bg").setAlignContent("start")
      ).setGap("35px").setAlignItems("start").setDynamicColumns(15)
    ).setMaxWidth("900px"),
    Content(
      Grid(
        Label("Let your fans enjoy your Drops where they feel home.").setTextSize("xl").setFontWeight("bold").setMargin("20px 10px").setTextAlign("center").addClass("opacity-60")
      ).setMargin("10px 0 40px"),
      Grid(
        Grid(...images()).addClass("icon-carousel").setGap("38px").setDirection("column"),
        Grid(...images().reverse()).addClass("icon-carousel").addClass("icon-carousel-reversed").setGap("38px").setDirection("column")
      ).addClass("icon-carousel-container").setGap("35px")
    ).setAlignContent("center").setHeight("380px").setMaxWidth("850px"),
    Grid(
      Label("Make it. Drop it.").setFontWeight("bold").setTextSize("6xl").setTextAlign("center"),
      Label("Distributing music should be accessible without any credit card.").setTextAlign("center").setFontWeight("bold").setTextSize("xl").addClass("opacity-60")
    ).setMargin("100px 0"),
    FullWidthSection(
      Content(
        Grid(
          Grid(
            Label("Why BBN\xA0Music?").setTextSize("3xl").setFontWeight("bold"),
            isMobileKeyFeatures.map(
              (mobile) => mobile ? Empty() : LinkButton("Drop your Music", "/c/music").setBorderRadius("complete").setPadding("2px 25px").addClass("orange-bg")
            ).asRefComponent()
          ).addClass("title").setGap().setAlignContent("space-between").setJustifyItems("start"),
          Grid(
            MIcon("percent").addClass("key-icon", "red"),
            Label("Lowest Cut").setFontWeight("bold"),
            Label("With our free plan, we only take a 3% cut of your revenue.")
          ).setGap("13px").setJustifyItems("start").setAlignContent("start"),
          Grid(
            MIcon("public").addClass("key-icon", "green"),
            Label("Global").setFontWeight("bold"),
            Label("We support all major and many smaller stores, without any extra cost for you.")
          ).setGap("13px").setJustifyItems("start").setAlignContent("start"),
          Grid(
            MIcon("all_inclusive").addClass("key-icon", "blue"),
            Label("Unlimited").setFontWeight("bold"),
            Label("No hard limits. You can manage as many Drops and Artists as you want.")
          ).setGap("13px").setJustifyItems("start").setAlignContent("start"),
          isMobileKeyFeatures.map(
            (mobile) => mobile ? Box(
              LinkButton("Drop your Music", "/c/music").setBorderRadius("complete").setPadding("2px 25px").addClass("orange-bg")
            ).addClass("call-to-action") : Empty()
          ).asRefComponent()
        ).setGap().setDynamicColumns(10).setPadding("50px 40px").setBorderRadius("large").addClass("free-tier-bg", "key-features")
      ).setMaxWidth("900px")
    ),
    Grid(
      Label("Loved by Artists").setFontWeight("bold").setTextSize("6xl").setTextAlign("center"),
      Label("See how our Artists value BBN Music").setTextAlign("center").setFontWeight("bold").setTextSize("xl").addClass("opacity-60")
    ).setMargin("100px 0"),
    Content(
      Grid(
        Label("The thing I love the most is the flexibility and the contactability of the entire BBN Music team. It is also just great to develop concepts and plans with motivated and very friendly people.").setTextAlign("start").addClass("italic-text").setFontWeight("bold"),
        Grid(
          Image(redz_default, "Avatar of Redz").setBorderRadius("complete").setAspectRatio("1/1").resizeToBox(),
          Label("Redz").setFontWeight("bold").setTextSize("xl")
        ).setRawColumns("40px auto").setAlignItems("center").setGap("16px")
      ).addClass("max-width-30rem").setPadding("95px 0 95px 0").setGap("21px"),
      Grid(
        Label("There is pretty much no other digital distributor that offers more and at the same time, works so closely with artists and who artists are so valued by and feel so understood by.").setTextAlign("end").addClass("italic-text").setFontWeight("bold"),
        Grid(
          Image(criticz_default, "Avatar of Criticz").setBorderRadius("complete").setAspectRatio("1/1").resizeToBox(),
          Label("Criticz").setFontWeight("bold").setTextSize("xl")
        ).setRawColumns("40px auto").setAlignItems("center").setGap("16px")
      ).setJustifyItems("end").addClass("max-width-30rem").setMargin("0 0 0 auto").setPadding("95px 0 95px 0").setGap("21px")
    ).setMaxWidth("680px"),
