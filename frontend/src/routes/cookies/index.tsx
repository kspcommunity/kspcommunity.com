  ...
  return (
    <div>
      ...
      <div class="container container-flex">
        <div>
          <p>
            Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our Cookies govern our relationship with you in relation to this website.
          </p>
          <p>
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Cookies for our website",
    },
  ],
};
